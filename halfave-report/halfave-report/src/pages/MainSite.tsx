...
const bodyHTML = `<!-- NAV -->
  <nav>
    ...
    <ul class="nav-links">
      <li><a href="https://halfave.co/risk.html" target="_blank" rel="noopener" style="color:rgba(255,255,255,0.5);text-decoration:none;font-size:0.875rem;font-weight:500;transition:color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,0.5)'">Risk Index</a></li>
  ...
  <section class="hero">
    ...
    <div class="hero-inner">
      ...
      <div class="hero-actions">
        ...
        <a href="https://halfave.co/risk.html" target="_blank" rel="noopener" class="hero-text-link">NYC Risk Index →</a>
      </div>
    </div>
