        ...
        <div style=\"border:0.5px solid rgba(0,0,0,0.12);border-radius:14px;overflow:hidden;margin-bottom:0;\">
          ...
          <div style=\"display:flex;\">
            ...
            <div style=\"padding:1.5rem;flex:1;background:#111e30;color:#f7f4ef;\">
              ...
              <a href=\"#\" onclick=\"document.querySelector('.bin-section')?.scrollIntoView({behavior:'smooth'});return false;\" style=\"display:inline-flex;align-items:center;gap:6px;margin-top:0.75rem;background:#f7f4ef;color:#111e30;font-size:0.8rem;font-weight:700;padding:0.55rem 1.25rem;border-radius:99px;text-decoration:none;transition:opacity 0.2s;\" onmouseover=\"this.style.opacity='0.88'\" onmouseout=\"this.style.opacity='1'\">
